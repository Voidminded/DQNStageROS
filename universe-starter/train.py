...
parser.add_argument('-e', '--env-id', type=str, default="Stage-v0",
                    help="Environment id")
parser.add_argument('-l', '--log-dir', type=str, default="/tmp/stage",
...
parser.add_argument('--visualise', action='store_true',
                    help="Visualise what robots are seing")
...
def run():
    ...
    cmds, notes = create_commands("a3c_stage", args.num_workers, args.remotes, args.env_id, args.log_dir, mode=args.mode, visualise=args.visualise)
    if args.dry_run:
